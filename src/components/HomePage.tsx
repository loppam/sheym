...
export default function HomePage({ onNavigate }: HomePageProps) {
  const services = [
    {
      ...
      description:
        "Complete social media strategy, content planning, and community engagement across all platforms.",
      price: "From ₦150,000",
      features: [
        "Content Calendar",
        "Daily Posting",
    ...
    },
    {
      ...
      description:
        "Professional photos, videos, and graphics that tell your brand story and engage your audience.",
      price: "From ₦250,000",
      features: [
        "Photo Shoots",
        "Video Production",
    ...
    },
    {
      ...
      description:
        "Strategic ad campaigns on Meta, TikTok, and Google that convert followers into customers.",
      price: "From ₦100,000",
    ...
    },
    {
      ...
      description:
        "Build a cohesive brand identity that resonates with your target audience and stands out.",
      price: "From ₦300,000",
      features: [
        "Brand Strategy",
        "Visual Identity",
    ...
    },
    {
      ...
      description:
        "Get your hacked, disabled, or suspended social media accounts back with our proven methods.",
      price: "From ₦150,000",
      features: [
        "Instagram Recovery",
        "Facebook Recovery",
  ...
  const testimonials = [
    {
      name: "Mercy Ogbogu",
      business: "Social Media Influencer",
      content:
        "If you have ANY problem with any social media account of yours Sheytimah Media will fix it",
      rating: 5,
    },
    {
      name: "Theacebeautybar",
      business: "Beauty Brand",
      content:
        "Sheytimah Media is amazing, they helped me recover my Instagram account and I'm very happy with the result",
      rating: 5,
    },
    {
      ...
      business: "Social Media Influencer",
      content:
      "Sheytimah Media is the best in the business, they are very professional and they know what they are doing",
      rating: 5,
    },
  ];
    ...
    <div className="home-page">
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-content">
          <div
            className="home-hero-badge fade-in-up"
            onClick={() =>
              window.open(
                "https://drive.google.com/drive/folders/1P0cTxuBCpupYpgVopqt92XYv8Egs_TNM",
                "_blank"
              )
            }
          >
          ...
          <h1 className="home-hero-title fade-in-up">Sheytimah Media</h1>

          <p className="home-hero-description fade-in-up">
            Helping brands grow online with creative strategy and result-driven
            marketing
          </p>
                    ...
                    <div className="home-service-features">
                      {service.features.slice(0, 3).map((feature, idx) => (
                        <div key={idx} className="home-service-feature">
                          ...
                          <span className="home-service-feature-text">
                            {feature}
                          </span>
                        </div>
                      ))}
      ...
      <section className="home-cta">
        <div className="home-cta-content">
          <h2 className="home-cta-title">Ready to Grow Your Brand?</h2>
